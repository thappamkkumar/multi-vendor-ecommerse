...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body>
		...
		<header class="container-fluid   d-flex align-items-center justify-content-between    " id="user_navigation_container">  
			 <!--<a href="{{route('userBack')}}" class="btn  p-0 px-2 text-dark border-0    user_naviagtion_controll_btn"  data-aos="zoom-in"    data-aos-duration="1000"  ><i class="bi bi-arrow-left fs-4 text-dark"></i></a>-->
			...
			<div class="navbar  navbar-expand  w-auto    "> 
				<ul class="navbar-nav d-flex align-items-center justify-content-center  "  >
					...
					@else
						...
						<li class="nav-item"><a href="{{route('userProfile')}}"  class="nav-link   " id="navigation_link_profile"     ><img src="{{$user_profile_image}}" class=" rounded-pill nav_profile_img    "   ></a></li>
