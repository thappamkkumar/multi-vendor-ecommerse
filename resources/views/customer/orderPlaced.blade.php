...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body>
		...
		<header class="container-fluid   d-flex align-items-center justify-content-between  " id="user_navigation_container">  
			...
			<button class="btn  p-0 px-2 text-dark border-0    user_naviagtion_controll_btn"   onclick="history.go(-5)">
			...
			<div class="navbar  navbar-expand  w-auto    "> 
				<ul class="navbar-nav d-flex align-items-center justify-content-center  "  >
					...
					@else
						...
						<a href="{{route('userProfile')}}"  class="nav-link   " id="navigation_link_profile"      ><img src="{{$user_profile_image}}" class=" rounded-pill nav_profile_img    " onerror="this.onerror=null;this.src='{{ asset('images/profile_icon.png') }}';"   ></a></li>
			...
			<section class="payment_container px-0 py-5 "  >
				<div> 
					...
					<div class="d-flex justify-content-center align-items-center py-4 ">
						<button class="btn btn-dark  mx-auto fw-bold"   onclick="history.go(-5)">
							{{$successMSG->button}}
						</button>
