	...
	<div class="w-100 h-auto p-2 p-md-4 shadow rounded">
		...
		<div class="  p-2 d-sm-flex flex-wrap flex-row-reverse align-items-center">	
			...
			<button type="button" class="btn m-1 " id="userVendorBtn"
							onclick='window.location.href =  `{{route("admin.productDeactivate", ["product" => $product])}}`;'>
				...
				<div class="collapse show  " id="basicDetail">
					<table class="table table-borderless   "   >
						...
						<tbody>
							...
							<tr class="border-bottom">
								<th class=" col-4  " >Seller Name :-</th>
								<td class="col-8     " >
									<a href="{{route('admin.userProfile', ['user' => $product->user])}}" 
										class="text-decoration-none">  {{$product->user->vendors->name}} </a>
								</td>
							</tr> 		
							<tr class="border-bottom">
							...
							<tr class="border-bottom">
								...
								<td class="col-8     " >{{$product->sale_price}}</td>
							</tr>		
							<tr class="border-bottom">
